...
while True:
    ...
    results = memory_rag.search_memory("池宇健说: 我要把yuki关掉了，内设一下\n陆羽说: emm怎么说呢\n池宇健说: 马上好", chat_id="1034986009", threshold=th)
    i = 0
    for result in results:
        print(f"记忆{i}", result)
        i+=1
    results2 = memory_rag.search_memory("若桜", chat_id="742134223", threshold=th)
    i = 0
